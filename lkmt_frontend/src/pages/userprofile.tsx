...
const mockOrders = [
  {
    ...
    total: 1299.97,
    items: [
      { name: "NVIDIA RTX 4080 SUPER x1", price: 999.99 },
      { name: "Intel Core i7-14700K x1", price: 299.98 },
    ],
  },
  {
    id: "ORD-002",
  ...
  },
  {
    ...
    total: 579.98,
    items: [
      { name: "ASUS ROG Strix Z790-E Gaming x1", price: 449.99 },
      { name: "Noctua NH-D15 Chromax x1", price: 129.99 },
    ],
  },
];
  ...
  const renderProfile = () => (
    <div>
      ...
      >
        <Row gutter={24}>
          <Col xs={24} sm={12}>
            <Form.Item label={<Text strong>First Name</Text>} name="firstName">
              <Input variant="filled" size="large" />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12}>
            <Form.Item label={<Text strong>Last Name</Text>} name="lastName">
              <Input variant="filled" size="large" />
            </Form.Item>
          </Col>
        </Row>
        <Form.Item label={<Text strong>Email Address</Text>} name="email">
          <Input variant="filled" size="large" disabled />
        </Form.Item>
        <Form.Item label={<Text strong>Phone Number</Text>} name="phone">
          <Input variant="filled" size="large" />
        </Form.Item>
        <Form.Item label={<Text strong>Date of Birth</Text>} name="dob">
          <Input variant="filled" size="large" />
        </Form.Item>
        <Form.Item>
          <Button
      ...
      {mockOrders.map((order) => (
        ...
        >
          ...
          >
            <div>
              <Space>
                ...
                <Tag color={order.statusColor} style={{ borderRadius: "12px" }}>
                  {order.status}
                </Tag>
              </Space>
              <div
                style={{ color: "#8c8c8c", fontSize: "13px", marginTop: "4px" }}
              >
          ...
          >
            ...
            <a href="#" style={{ color: "#212529", fontWeight: 500 }}>
              View Details
            </a>
          </div>
        </Card>
        ...
        >
          ...
          >
            ...
            <Space>
              ...
              <Button type="text" danger style={{ fontWeight: 500 }}>
                Delete
              </Button>
            </Space>
          </div>
    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <Row gutter={24}>
          ...
          <Col xs={24} md={6}>
            <Card
              style={{ borderRadius: "12px", borderColor: "#e8e8e8" }}
          ...
          <Col xs={24} md={18}>
            ...
            >
              ...
              {!["Profile", "Orders", "Addresses", "Settings"].includes(
                activeTab,
              ) && (
                <div
                  style={{
