...
const FeaturesSection: React.FC = () => {
  ...
  const features = [
    ...
    {
      icon: <SafetyCertificateOutlined style={{ fontSize: '28px', color: '#52c41a' }} />, // Biểu tượng khiên bảo hành
  ...
  return (
    <div style={{ backgroundColor: '#f8f9fa', padding: '40px 24px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ borderTop: '1px solid #ced4da', paddingTop: '40px', paddingBottom: '16px' }}>
          <div style={{ 
            display: 'flex', 
            ...
            <div>
              ...
              <Text type="secondary">Hand-picked components for your build</Text>
            </div>
