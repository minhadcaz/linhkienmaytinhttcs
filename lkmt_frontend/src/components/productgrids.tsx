        ...
        <Row gutter={[2, 3]}>
          {mockProducts.map((product) => (
            <Col xs={24} sm={12} md={8} lg={6} key={product.id}>
              <Card
                hoverable
                styles={{ body: { padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' } }}
                style={{
              ...
              >
                ...
                >
                  ...
                  <div style={{ position: 'absolute', top: 0, left: 0, display: 'flex' }}>
                     ...
                     <span style={{ color: '#adb5bd', fontSize: '10px', padding: '4px' }}>t Image</span>
                  </div>
                  
                  {/* Nhãn FEATURED (Góc trên phải) */}
                  <span style={{ position: 'absolute', top: 0, right: 0, backgroundColor: '#212529', color: 'white', padding: '4px 8px', fontSize: '12px', fontWeight: 'bold' }}>
                    FEATURED
                  </span>

                  {/* Hình mô phỏng linh kiện */}
                  <div style={{ width: '60px', height: '60px', backgroundColor: '#ced4da', marginBottom: '8px' }}></div>
                  <Text type="secondary" style={{ fontSize: '12px', letterSpacing: '1px' }}>
                    {product.category}
                  </Text>
                </div>
                ...
                <div style={{ flex: 1 }}>
                  {/* Tên sản phẩm */}
                  <Title level={5} style={{ margin: '0 0 8px 0', fontSize: '14px', minHeight: '40px' }}>
                    {product.name}
                  </Title>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    <Text strong style={{ fontSize: '18px', marginRight: '8px' }}>
                      ${product.price}
                    </Text>
